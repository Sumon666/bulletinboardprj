          ...
          <form method="POST" action="{{ url('updateuserdata') }}" enctype="multipart/form-data">
            ...
            <div class="bdiv">
              <div>
                ...
                <img src="images/{{isset($udata->profile) ? $udata->profile : ''}}" class="txtupload" name="img"
                  id="img" width="70" height="70" />
              ...
              <div class="allBtn">
                ...
                <a href="{{ url('cancelupdatedata') }}"><input type="button" class="btnClear" name="cancel"
                    value="Cancel" /></a>
              </div>
            </div>
          </form>
