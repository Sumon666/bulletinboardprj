    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          <form method="POST" action="{{ url('searchuser') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <div class="col-md-6">
              <a class="btn btn-primary btn-block" href="{{ url('usercreate') }}"> Add</a>
            </div>
          </div>
          @endif
          <div class="container">
            <table class="table table-bordered" style="margin-left:-35px;">
              ...
              <tbody>
                ...
                <tr>
                  <td><a href="{{ url('userdetail', $user->name) }}"
                      enctype="multipart/form-data">{{isset($user->name) ? $user->name : ''}}</a></td>
                  ...
                  @if(auth()->user()->type==0)
                  <td><a href="{{ url('deleteuser', $user->id) }}" id="btnDeleteUser">Delete</a></td>
                  @endif
                </tr>
                @endforeach
              </tbody>
