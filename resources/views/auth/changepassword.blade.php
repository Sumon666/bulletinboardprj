    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          <form method="POST" action="{{ url('passwordvalidate') }}">
            @csrf
            <div>
              <table>
                <tr>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input class="form-control{{ $errors->has('current') ? ' is-invalid' : '' }}" type="password"
                  name="current">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input class="form-control{{ $errors->has('confirm') ? ' is-invalid' : '' }}" type="password"
                  name="confirm">
            ...
            <div class="allBtn">
              ...
              <a href="{{ url('clearpassword') }}"><input type="button" class="btn btn-outline-success btn-lg" name="clear"
                  value="Clear" /></a>
            </div>
          </form>
        </div>
