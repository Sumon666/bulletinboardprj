...
class PostController extends Controller
{
    ...
    public function show(Request $request)
    {
        if (isset($request->title) && isset($request->description)) {
            ...
            if(Posts::where('title',$request->title)->exists()) {
                return redirect('post')->with('postError', 'Post already exists!!')->withInput();
            }
    ...
    public function getPostList()
    {
        ...
        if (isset($sdata)) {
            ...
            return view('post.postlist')->with('ListError', 'No Details found. Try to search again !')->withInput();
        }
    }
    ...
    public function uploadCSV(Request $request)
    {
        ...
        if (in_array(strtolower($extension), $valid_extension)) {
            ...
            if ($fileSize <= $maxFileSize) {
                ...
                return redirect()->back()->with("error","Uploaded file must be CSV type and file size is maximum 2MB");
            }
        }
        return redirect('postlist');
    }
